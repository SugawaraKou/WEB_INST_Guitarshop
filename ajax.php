...
$(document).on('click','#dodajKorpa',function(e) {
	...
	$.ajax({
		...
		success: function(data){
			$('#dodajKorpaInfo').html("<div class='alert alert-info'>Товар добавлен в корзину</div>");
		}
	});
...
?>
	...
	$(document).on('click','#poruciDugme',function(e) {
		...
		$.ajax({
			...
			url: "ajax/poruci.php",
			success: function(data){
				$('#poruciInfo').html("<div class='alert alert-info' style='padding:5px;text-align:left'>Заказ отправлен!</div>");
			}
		});
		$("#poruciModal").hide();
		$("#poruciDugme").hide();
...
?>
	...
	$(document).on('click','#dodaj',function(e) {
		...
		$.ajax({
			...
			success: function(data){
				$('#dodajInfo').html("<div class='alert alert-info' style='float:right;width:150px;padding:5px'>Пользователь добавлен</div>");
			}
		});
	...
	$(document).on('click','#izmeni',function(e) {
		...
		$.ajax({
			...
			success: function(data){
				$('#dodajInfo').html("<div class='alert alert-info' style='float:right;width:150px;padding:5px'>Пользователь отредактировал</div>");
...
?>
	...
	$(document).on('click','#dodaj',function(e) {
		...
		$.ajax({
			...
			success: function(data){
				$('#dodajInfo').html("<div class='alert alert-info' style='float:right;width:150px;padding:5px'>Категория добавлена</div>");
			}
		});
	...
	$(document).on('click','#izmeni',function(e) {
		...
		$.ajax({
			...
			success: function(data){
				$('#dodajInfo').html("<div class='alert alert-info' style='float:right;width:150px;padding:5px'>Категория изменена</div>");
...
?>
	...
	$(document).on('click','#dodaj',function(e) {
		...
		$.ajax({
			...
			success: function(data){
				$('#dodajInfo').html("<div class='alert alert-info' style='float:right;width:150px;padding:5px'>Товар добавлен</div>");
			}
		});
	...
	$(document).on('click','#izmeni',function(e) {
		...
		$.ajax({
			...
			success: function(data){
				$('#dodajInfo').html("<div class='alert alert-info' style='float:right;width:150px;padding:5px'>Товар изменен</div>");
