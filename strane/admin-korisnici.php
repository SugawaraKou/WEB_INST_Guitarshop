		...
		<div id="dodajFormaToggle">
			<form id="dodajForma">
				...
				<div class="col-md-4"><br/>
					...
					{
						?>
						<button type="button" class="btn btn-fefault cart" id="izmeni"><i class="fa fa-check"></i> редактировать</button>
						<?php
					}
					else
					{
						?>
						<button type="button" class="btn btn-fefault cart" id="dodaj"><i class="fa fa-check"></i> Добавить</button>
						<?php
					}	
					?>
