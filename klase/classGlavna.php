...
class Glavna
{
	...
	public function korpaPrikaz()
	{
		...
		<table class="table ">
			<thead>
				<tr class="cart_menu">
					<td class="image hidden-xs">Наименование</td>
					<td class="description"></td>
					<td class="price hidden-xs">Цена</td>
					<td class="quantity hidden-xs">Количество</td>
			...
			<tbody>
				...
				{
					echo '<tr><td colspan="6"><div class="alert alert-info">Корзина пуста</div><br/></td></tr>';
				}
				else
				{
					while($red=$db->procitajRed($rez))
		...
		if(mysqli_num_rows($rez) > 0)
		{
			...
			<div style="border:1px solid #E6E4DF;margin-top:15px;">
				<h2 class="text-center">В итоге: <?php echo $totalCena;?> RU</h2>
				<a style="width:90%" class="btn btn-fefault cart" href="#poruci" id="poruciModal" data-toggle="modal"><i class="fa fa-check"></i> Заказать</a>
				<br/><br/>
			</div>
			</div>
					...
					<div class="modal-dialog ">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<h3 style="float:right">В итоге: <?php echo $totalCena;?> RU</h3>
